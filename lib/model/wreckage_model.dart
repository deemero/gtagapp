...
// To parse this JSON data, do
//
//     final resPostWreckage = resPostWreckageFromJson(jsonString);

import 'dart:convert';

ResPostWreckage resPostWreckageFromJson(String str) =>
    ResPostWreckage.fromJson(json.decode(str));

String resPostWreckageToJson(ResPostWreckage data) =>
    json.encode(data.toJson());

class ResPostWreckage {
  ResPostWreckage({
    required this.status,
    required this.message,
    required this.data,
  ...
  factory ResPostWreckage.fromJson(Map<String, dynamic> json) =>
      ResPostWreckage(
        status: json["status"] == null ? null : json["status"],
        message: json["message"] == null ? null : json["message"],
        data: json["data"] == null ? null : Data.fromJson(json["data"]),
